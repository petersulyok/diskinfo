...
### Fixed
- Non-deterministic unit test coverage for `Disk.get_temperature()` sudo parameter fixed.


## [4.1.1] - 2026-03-16

### Fixed
- Feature set and documentation updated with the new raw file system capabilities.
...
### Fixed
- Fix: class diagram is not visible, graphviz dependency added to `readthedocs.yaml` for public API on
readthedocs.io site.
...
### Added
- Refactoring of a file system attributes with the change of the public API (fixing issue [#7](https://github.com/petersulyok/diskinfo/issues/7)):
