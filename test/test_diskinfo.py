...
class DiskInfoTest(unittest.TestCase):
    ...
    test_disks_list = [
        ...
        [["nvme0n1", "nvme0n2", "loop0"], [DiskType.NVME, DiskType.NVME, DiskType.LOOP]],
        ...
        [["sda", "sdb", "loop0"], [DiskType.SSD, DiskType.SSD, DiskType.LOOP]],
        ...
        [["sda", "sdb", "loop0"], [DiskType.HDD, DiskType.HDD, DiskType.LOOP]],
        [["sda", "nvme0n1", "sdb"], [DiskType.HDD, DiskType.NVME, DiskType.SSD]],
        [["sda", "sdb", "nvme0n1"], [DiskType.HDD, DiskType.SSD, DiskType.NVME]],
        [["loop0", "loop1", "loop2"], [DiskType.LOOP, DiskType.LOOP, DiskType.LOOP]],
        ...
        [["sda", "sdb", "loop0", "nvme0n1", "nvme0n2", "sdd", "nvme0n3", "sde"],
         [DiskType.HDD, DiskType.SSD, DiskType.LOOP, DiskType.NVME, DiskType.NVME, DiskType.HDD,
    ...
    def pt_gdn_p1(self, disk_names: List[str], disk_types: List[int], error: str) -> None:
        ...
        with patch('os.listdir', mock_listdir), \
            ...
            count_loop = disk_types.count(DiskType.LOOP)
            self.assertEqual(di.get_disk_number(included={DiskType.NVME, DiskType.SSD, DiskType.HDD, DiskType.LOOP}),
                             count_nvme + count_ssd + count_hdd + count_loop, error)
            ...
            # This case will not work: if included list is empty then every type will be included automatically and
            # this will be a conflicting with the excluded list.
            # self.assertEqual(di.get_disk_number(excluded={DiskType.NVME, DiskType.SSD, DiskType.HDD, DiskType.LOOP}),
            #                  0, error)
            del di
        del my_td
